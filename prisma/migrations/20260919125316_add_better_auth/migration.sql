/*
  ...
  - Renaming the `User` table to `user` to match Better Auth's expected table name (data is preserved).
...
-- RenameTable (preserves existing rows instead of dropping/recreating)
